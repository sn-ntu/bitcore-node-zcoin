...
function getDefaultConfig(options) {
    ...
    var defaultConfigFile = path.resolve(defaultPath, './bitcore-node-zcoin.json');
            ...
            servicesConfig: {
                bitcoind: {
                    spawn: {
                        ...
                        //exec: path.resolve(__dirname, defaultPath,'./data/zcoind')
                        //exec: path.resolve(__dirname, './data/zcoind')
